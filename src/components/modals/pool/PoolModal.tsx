...
function OrderModal({ isOpen, item, onClose }: Props) {
    ...
    async function remove() {
        ...
        try {
            ...
            const { data, total, success, message, ...rest } = await Api.delete('/api/auth/pool', { id: edited.id })
    ...
    async function save() {
        ...
        try {
            ...
            const { data, total, success, message, ...rest } = await Api.post('/api/auth/pool', formated)
